  ...
  return (
    <div className="container">
      ...
      <p className="description" dangerouslySetInnerHTML={{
        __html: "How I got to the project:<br />Because my last project was basically doing the same thing just that now I had more knowledge I decided to keep going with this project.<br /><br />What I did:<br />I learned here a lot about matplotlib as well as plotting and although I didn&apos;t build an algorithm I improved much towards my goal and it also taught me how to plot stocks so I can also incorporate machine learning to it."
      }} />
