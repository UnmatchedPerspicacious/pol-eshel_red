  ...
  return (
    <div className="container">
      ...
      <p className="description">
        "How I got to the project: Basically because I already had the algo
        ...
        help my future algorithm learn. What I did: I built a machine learning
        ...
        good because basically the lower it is the more accurate the model &rang;."
      </p>
      <div className="images">
        <div className="image-container">
          {/* Use standard img tag for local images */}
          <img className="image" src={ml} alt="ML stock prediction" />
        </div>
        <div className="image-container">
          {/* Use standard img tag for local images */}
          <img className="image" src={ml} alt="ML stock prediction" />
